	...
	<div class="cart_main">
		...
		?>
				<tr>
					...
					<td>
						<form id='myform' method='get' action='cart.php'>
		<?php
		...
		<?php
			if ($_SESSION['loggued_on_user'] != "")
				echo '<a href="archive_cart.php"><button class="buy validate">Validate cart</button></a>';
			else
				echo '<p class="validate">Please <a href="forms/login.php">login</a> to validate your cart.</p>';
		?>
	</div>
</body>
